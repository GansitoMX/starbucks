                            ...
                            <div className="md-flex-text">
                                <div className="earning-stars">
                                    <div className="earning-stars-content">
                                        ...
                                        <p className="es-content">
                                            Earn 1 Star per $1 spent when you scan
                                            your member barcode in the app, then
                                            pay with cash, credit/debit cards or
                                            mobile wallets at participating stores.
                                            You can also earn 1 Star per $1 spent
                                            when you link a payment method and pay
                                            directly through the app.
                                        </p>
                                        <p className="es-content">
                                            Earn 2 Stars per $1 spent when you
                                            load funds and pay with your digital
                                            Starbucks Card in the app. You can also
                                            earn 2 Stars per $1 spent when you pay
                                            in-person at a participating store with
                                            your registered physical Starbucks Card
                                            or scan your member barcode in the app,
                                            and then use any physical Starbucks
                                            Card (regardless of whether it is
                                            registered) to complete the purchase.
                                        </p>
                                    </div>
                                    <div>
                                        ...
                                        <p className="es-content">Free refills
                                            ...
                                            Birthday Reward, you must have
                                            made at least one Star-earning
                                            transaction.
                                        </p>
                                    </div>
                                </div>
