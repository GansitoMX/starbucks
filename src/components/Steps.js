            ...
            <div className='container-layout'>
                <div className="content-column">
                    <div className='content-column-inner'>
                        ...
                        <ol className='multiThumbnailsRow'>
                            <li className='card-1'>
                                <div className='image-center'>
                                    <img className='sb-imageFade__show' src="\images\getting_started_1.jpg" alt="step1" width={48} />
                                </div>
                                <div className='card-content'>
                                    <h3 className='header-card'>Create an account</h3>
                                    <p className='pt3'>To get started, <a className='colorGreen' href="https://www.starbucks.com/account/create">
                                        join now</a>
                                        . You can also 
                                        <a className='colorGreen' href='https://starbucks.app.link/VLa2I3inh9'> Join in the app </a> 
                            ...
                            <li className='card-1'>
                                <div className='image-center'>
                                    <img className='sb-imageFade__show' width={48} src="\images\getting_started_2.jpg" alt="Create account" />
                                </div>
                                <div className='card-content'>
                                    ...
                                    <p className='pt3'>
                                        Use cash, credit/debit card or save some time and pay right through the app. You’ll collect Stars all ways. 
                                         <a className='colorGreen' href="https://www.starbucks.com/account/create"> Learn how</a>
                                    </p>
                                </div>
                            </li>
                            <li className='card-1'>
                                <div className='image-center'>
                                    <img className='sb-imageFade__show' width={48} src="\images\getting_started_3.jpg" alt="Create account" />
                                </div>
                                <div className='card-content'>
